...
function AboutSection() {
  return (
    <section className="relative overflow-hidden text-white py-20 backdrop-blur-xl dark:bg-black/95">
      {/* Main container */}
      <div className="relative z-10 w-[80%] container mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-14">

        {/* Text content */}
        <div className="flex-1 space-y-6  text-left">
          <span className="inline-block bg-cyan-500/10 text-white px-4 py-1 rounded-full text-sm font-orbitron leading-relaxed tracking-widest uppercase">
            About Us
          </span>
          ...
          <p className="font-orbitron text-[1.2rem] leading-relaxed mb-6 text-gray-200">
            At <span className="text-[#39ff14] font-semibold">Neuraq Technologies</span>, we specialize in AI-powered digital identity solutions designed to help individuals and small businesses establish secure online identities at affordable prices. Our mission is to make advanced digital tools accessible and practical for everyone, empowering growth and security in the digital world.
          </p>

          <p className="font-orbitron text-[1.2rem] leading-relaxed mb-6 text-gray-200">
            We are committed to developing inclusive AI that breaks communication barriers for people with disabilities. Our ongoing research and flagship product <span className="text-[#39ff14] font-semibold">Neuraq</span> Smart Care for the healthcare sector reflect our dedication to creating innovative solutions that make the digital future more accessible for all.
          </p>
          ...
          <div className="mt-8 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 font-orbitron text-[1rem] leading-relaxed text-sm">
                We turn impossible problems into AI-powered <br /> solutions effortlessly.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap  gap-6 pt-8 font-orbitron">
            <Link
              ...
              className="relative inline-flex items-center gap-3 px-8 py-4 rounded-full overflow-hidden group
                bg-gradient-to-r from-[#39ff14] to-[#00f2fe] text-black font-semibold tracking-wide
                shadow-[0_0_18px_rgba(0,255,200,0.35)] transition-transform duration-300 hover:scale-[1.03]"
            >
              <span className="relative z-10 text-white flex items-center gap-3">
                VIEW OUR BRAND STORY <ArrowRight className="w-5 h-5" />
              </span>
            ...
            <Link
              to="/about"
              className="relative inline-flex items-center gap-3 px-8 py-4 rounded-full border border-[#ffffff50] text-gray-200
                overflow-hidden group transition-all duration-300 hover:scale-[1.03] hover:border-[#39ff14] hover:text-[#39ff14]"
            >
        ...
        {/* Image Section */}
        <div className="flex-1 relative flex h-[800px] justify-center items-center">
          <div className="relative w-[90%] h-[80%] flex justify-center items-center">
            <img src={HomeAb} alt="Illustration of Neuraq Technologies Lab" className="w-full h-full object-cover rounded-2xl"/>
            {/* Corners */}
